...
/**
 * This class replaces the need of spring-config-servlet.xml
 * (Pure Java configuration, no xml)
 * <p>
 * It contains the configuration for the various beans needs for Hibernate DB
 * access.
 */
@Configuration // tells Spring this is a configuration class
@EnableWebMvc // similar to the XML config <mvc:annotation-driven />
@EnableTransactionManagement // adds transaction manager support
@ComponentScan("com.gemalto") // where to scan for components recursively
